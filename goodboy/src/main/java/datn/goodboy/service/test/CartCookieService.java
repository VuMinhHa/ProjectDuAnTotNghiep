...
public class CartCookieService {
  ...
  private String serializeCart(Map<Integer, Integer> cartItems) {
    ...
    try {
      return URLEncoder.encode(objectMapper.writeValueAsString(cartItems), StandardCharsets.UTF_8);
  ...
  private Map<Integer, Integer> deserializeCart(String cartValue) {
    ObjectMapper objectMapper = new ObjectMapper();
    try {
      String decodedValue = URLDecoder.decode(cartValue, StandardCharsets.UTF_8);
